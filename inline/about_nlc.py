...
main_data = {
    ...
    f"about True":{"text":"Серебристые облака - это сравнительно редкое атмосферное явление, крайне разрежённые облака, состоящие из мелких льдинок, которые подсвечивает солнце. Возникают эти облака в мезосфере под мезопаузой (на высоте 76—85 км над поверхностью Земли) и видимые в глубоких сумерках, непосредственно после заката или перед восходом Солнца. \n Также у серебристых облаков есть свои типы, о них вы можете узнать нажав на кнопку ниже", "photo":r"photo/NLC.jpg", "murkup":[f"type {True}", "main True"], "text_murkup":["Типы СО", "Назад"]},

    f"light True":{"text":"Яркость серебристых облаков - один из важнейших параметров который нужно записывать при наблюдениях. Вы можете выбрать о какой конкретном показателе яркости вы хотите посмотреть.", "photo":r"photo/light.png", "murkup":["light 1", "light 2", "light 3", "light 4", "light 5", "choise_par True"], "text_murkup":["1", "2", "3", "4", "5", "Назад"]},
    "light 1":{"text":"Индекс яркости 1 \n Очень слабые серебристые облака, едва видимые на фоне сумеречного неба; определимы только при очень тщательном изучении неба.", "photo":r"photo/light_1.png", "murkup":[f"light {True}"]},
    "light 2":{"text":"Индекс яркости 2 \n Серебристые облака легко определимы, но имеют низкую яркость.", "photo":r"photo/light_2.png", "murkup":[f"light {True}"]},
    "light 3":{"text":"Индекс яркости 3 \n Серебристые облака хорошо видны, четко выделяясь на фоне сумеречного неба.", "photo":r"photo/light_3.png", "murkup":[f"light {True}"]},
    "light 4":{"text":"Индекс яркости 4 \n Серебристые облака очень яркие и привлекают внимание наблюдателей-неспециалистов.", "photo":r"photo/light_4.png", "murkup":[f"light {True}"]},
    "light 5":{"text":"Индекс яркости 5 \n Серебристые облака крайне яркие и заметно освещают повернутые к ним предметы.", "photo":r"photo/light_5.png", "murkup":[f"light {True}"]},
    ...
    "weather 1":{"text":"А – облаков в зоне сумеречного сегмента нет или их наличие не мешает наблюдениям. Облачность до 20%.", "photo":r"photo/weather_1.png", "murkup":["weather True"]},
    "weather 2":{"text":"Б - сумеречная часть неба незначительно покрыта облачностью (сегмент закрыт от 20 до 50%.)", "photo":r"photo/weather_2.png", "murkup":["weather True"]},
    "weather 3":{"text":"В - сумеречная часть неба значительно покрыта облачностью (сумеречный сегмент закрыт на 50–80%)", "photo":r"photo/weather_3.png", "murkup":["weather True"]},
    "weather 4":{"text":"Г – Сумеречная часть неба почти полностью покрыта облачностью (>80%), наблюдаются лишь редкие просветы (сегмент закрыт от 80 до 95%)", "photo":r"photo/weather_4.png", "murkup":["weather True"]},
    "weather 5":{"text":"Д – Сумеречная часть неба полностью закрыта облачность (сумеречный сегмент закрыт на 95–100% облачностью.)", "photo":r"photo/weather_5.png", "murkup":["weather True"]}
}
...
def main_handler(call, query):
    ...
    changes(message=call.message, text=text, media=photo, murkup=murkup)